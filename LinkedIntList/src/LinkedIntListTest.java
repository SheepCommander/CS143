...
//   }
  ...
  public void testAddElementAtPosition() {
    ...
    tester.add(0, 300);
    assertEquals("after adding elements the new position 0 should be", 300, tester.get(0));
    assertEquals("after adding elements the new position 1 should be", 0, tester.get(1));
    assertEquals("after adding elements the new position 2 should be", 200, tester.get(2));
  ...
  public void testRemoveElementAtPositionAndGet() {
    ...
    x = tester.get(0);
    tester.remove(0);
    assertEquals("after remove value at index 0 no longer exist in the list", -1, tester.indexOf(x));
